...
This class is part of an attempt to develop a new architectural canon by a study of the occult. It proceeds from the hypothesis that architecture has an origin, or series of early archetypal forms and functions, that have only very recently become decipherable after millennia of confusion.

Implicit in this approach is the idea that architecture's beginnings have been systematically occulted–which is to say, hidden–allowing architecture history as we know it to grow in a vacuum of verifiability. Amateurs untethered to dominant paradigms of theory have long chipped away at the underlying cosmologies and codes that informed sacred and public architecture, from the pyramids to post-modernism, but it's only after decades of Internet connected sharing, collation, and comparison of this information with the hard data of maps and artifacts and new scientific methods of analyzing them that the hegemony of the Official Story is breaking down.

A new story is emerging in the cracks between architecture history, contemporary science and technology, and the reemergence of the practice of magic in plain sight. It is a conspiratorial counterhistory that you won't read about in architecture discourse because it was constructed under the very veil that architecture discourse provided. We will piece together this story as a codex to unlock mysteries hidden in architecture past and present that have lessons for our contemporary crises of climate and authority.

This story requires turning most of what you think you know upside down. It takes place down the rabbit hole of anomalous events and impossible evidence. It is built on a science of telepathy and psychokinesis, the acrobatics of mind recently verified by science. It traces the connection between cave art and psychedelics and CIA mind control programs to Burning Man and Elon Musk's rockets. It incorporates quantum mechanics and artificial intelligence into a new rendering of ancient cosmologies. It passes through the darkness of eugenics and neo-monarchism into decentralized currencies like Bitcoin and conspiracy theories of aliens and UFOs. Ultimately, you will be given a wide spectrum of informational contraband from which to construct your own metaphysics to recontextualize architecture and the meaning of the term "architect" for your own practice.


#### Premise
The purpose of this course is to end the semester with each student having a viable definition of "architect." It begins from the premise that "architect" is unable to be defined in abstract, that an absolute architecture is not possible. Rather, to define "architect" we must begin with a metaphysical frame. This course will present a particular cosmology as a starting point for each student to branch off into their own. We will encounter it through occult ideas, contemporary philosophy, and digital culture, and challenge it with bleeding edge science.

#### Deliverables
You will collectively develop a *Playbook of Inclusions*, a catalogue of various architecture-specific techniques for stretching reality to be more inclusive of experiences outside of Official Reality.
